...
Why this exists
---------------
This repository relies on fifteen gates to detect its own drift, and **none of
...
def test_gate_list_was_discovered() -> None:
    ...
    assert len(GATES) >= 15, f"only {len(GATES)} gates discovered; the suite has had 15 since 2026-09-09"
